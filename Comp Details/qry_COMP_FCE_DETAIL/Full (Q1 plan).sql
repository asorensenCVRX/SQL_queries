...
SELECT
    ...
    B.IMPLANTED_YYYYQQ,
    ISNULL(B.QTY, 0) [QTY],
    ISNULL(B.BATWIRE_QTY, 0) BATWIRE_QTY,
                ...
                FROM
                    (
                        ...
                        */
                        ...
                        FROM
                            (
                                ...
                                WHERE
                                    ...
                                    AND OPP_COUNTRY = 'US'
                                    AND INDICATION_FOR_USE__C = 'Heart Failure - Reduced Ejection Fraction'
                                    AND REASON_FOR_IMPLANT__C = 'De novo - BATwire'
                                    AND IMPLANTED_YYYYMM = (
                                        SELECT
                                            YYYYMM
                                        FROM
                        ...
                        WHERE
                            B.EMAIL IS NOT NULL
                            /*/** REGIONAL BATWIRE END **/
                            */
                        UNION
                        ALL
                        /*/** TERRITORY BATWIRE START **/
                        */
                        SELECT
                            REGION,
                            REG_ID,
                        ...
                        WHERE
                            B.EMAIL IS NOT NULL
                            /*--------WHERE SALES_CREDIT_FCE_EMAIL = 'ldasilvacampos@cvrx.com'*/
                    ) AS T1
